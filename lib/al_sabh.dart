                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text("$currentReadCount", style: TextStyle(fontSize: 35,fontWeight: FontWeight.bold,color: Colors.deepPurple)),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text("$totalReadCount", style: TextStyle(fontSize: 35,fontWeight: FontWeight.bold,color: Colors.deepPurple)),
                          ],
                        ),
                      ),
                      Padding(
